...
import net.tospay.auth.databinding.FragmentBankAccountBinding;
 ...
 */
public class BankAccount extends BaseFragment<FragmentBankAccountBinding, AccountViewModel>
    ...
    private void fetchData() {
        mViewModel.fetchBank();
        mViewModel.getBankAccount().observe(getViewLifecycleOwner(), resource -> {
            if (resource != null) {
                switch (resource.status) {
                    ...
                    case SUCCESS:
                        if (resource.data != null) {
                            ...
                            Toast.makeText(getActivity(), "No linked bank accounts", Toast.LENGTH_SHORT).show();
                        }
                        break;
                }
            }
    ...
    public void OnAccountSelected(Account account) {
        AccoutDeleteDialog.newInstance(account).show(getChildFragmentManager(), BankAccount.class.getSimpleName());
    }
    ...
    private void deleteAccount(Account account) {
        ...
        mViewModel.delete(account, AccountType.BANK);
