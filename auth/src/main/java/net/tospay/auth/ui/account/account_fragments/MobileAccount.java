...
import net.tospay.auth.databinding.FragmentMobileAccountBinding;
 ...
 */
public class MobileAccount extends BaseFragment<FragmentMobileAccountBinding, AccountViewModel>
implements AccoutDeleteDialog.OnAccountActionListener, AcountsAdapter.AccountselectListener {

    private FragmentMobileAccountBinding mBinding;
    ...
    public int getLayoutId() {
        return R.layout.fragment_mobile_account;
    }
    ...
    private void fetchData(){
        ...
        dialog.setMessage("Fetching accounts...");
        dialog.show();
        dialog.setCanceledOnTouchOutside(false);
        mViewModel.fetchMobile();
        mViewModel.getMobileAccount().observe(getViewLifecycleOwner(), resource -> {
            if (resource != null){
                switch (resource.status){
                    ...
                    case SUCCESS:
                        ...
                        if (resource.data != null) {
                            ...
                            Toast.makeText(getActivity(), "No linked Mobile accounts", Toast.LENGTH_SHORT).show();
                        }
                        break;
    ...
    private void deleteAccount(Account account) {
        ...
        mViewModel.delete(account, AccountType.MOBILE);
    ...
    public void OnAccountSelected(Account account) {
        AccoutDeleteDialog.newInstance(account).show(getChildFragmentManager(),MobileAccount.class.getSimpleName());
    }
